                ...
                headers: [
                    {
                        ...
                        value: [
                            ...
                            `img-src 'self' blob: data: https://tile.openstreetmap.org https://*.tile.openstreetmap.org https://*.tile.opentopomap.org https://server.arcgisonline.com https://*.basemaps.cartocdn.com https://lh3.googleusercontent.com ${TITILER} ${PROTOMAPS_ORIGIN} ${MINIO}`.trim(),
